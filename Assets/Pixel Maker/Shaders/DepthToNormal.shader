Shader "Custom/DepthNormal"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                half2 rot = half2(uv.x, uv.y);
                return SAMPLE_DEPTH_TEXTURE_LOD(_CameraDepthTexture, float4(rot, 0.0, 0.0));
            }
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half3 WorldNormal = mul((float3x3)unity_MatrixInvV, viewNormal);
                 WorldNormal = float3(WorldNormal.x, -WorldNormal.y, WorldNormal.z);
